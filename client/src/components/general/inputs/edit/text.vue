<template lang='pug'>
	b-form-fieldset(:horizontal='true',:label='label',:feedback='feedback',:description='description')
		b-form-input(type='text',:size='size',:textarea='textarea',:disabled='disabled',v-model='currentValue',v-on:focus='focus',v-on:blur='blur',:class='inputClass',:formatter='formatter')
</template>

<script>
	import _ from 'lodash'

	let DEFAULT_DEBOUNCE_TIMEOUT = 500
